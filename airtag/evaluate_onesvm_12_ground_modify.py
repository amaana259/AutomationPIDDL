...
embedding_path = base_dir / "embedding_data" / (suffix + f"M12_benign.json")
...
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M121_test.json")
...
strr = np.load(base_dir / "ground_data" / (suffix + "M1h1_number.npy"))
strr=list(strr)
...
base_dir = Path(__file__).resolve().parent
log_file = base_dir / "training_data" / f"{suffix}testing_preprocessed_logs_M1-CVE-2015-5122_windows_h1"
...
start_load_test_time=time.time()
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M122_test.json")
f = open(embedding_path, 'r')
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr = np.load(base_dir / "ground_data" / (suffix + "M1h2_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
base_dir = Path(__file__).resolve().parent
log_file = base_dir / "training_data" / f"{suffix}testing_preprocessed_logs_M1-CVE-2015-5122_windows_h2"
start_cali_time = time.time()
...
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M123_test.json")
f = open(embedding_path, 'r')
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr = np.load(base_dir / "ground_data" / (suffix + "M2h1_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
log_file = base_dir / "training_data" / f"{suffix}testing_preprocessed_logs_M2-CVE-2015-5119_windows_py_h1"
...
start_load_test_time=time.time()
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M124_test.json")
f = open(embedding_path, 'r')
...
#print(end_load_test_time-start_load_test_time)
value2=np.array(strr[:-1])
strr = np.load(base_dir / "ground_data" / (suffix + "M2h2_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
log_file = base_dir / "training_data" / f"{suffix}testing_preprocessed_logs_M2-CVE-2015-5119_windows_py_h2"
