...
embedding_path = base_dir / "embedding_data" / (suffix + f"M34_benign.json")
...
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M341_test.json")
...
strr = np.load(base_dir / "ground_data" / (suffix + "M3h1_number.npy"))
strr=list(strr)
...
log_file = base_dir / "training_data" / f"{suffix}training_preprocessed_logs_M3-CVE-2015-3105_windows_py_h1"
...
start_load_test_time=time.time()
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M342_test.json")
f = open(embedding_path, 'r')
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr = np.load(base_dir / "ground_data" / (suffix + "M3h2_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
log_file = base_dir / "training_data" / f"{suffix}training_preprocessed_logs_M3-CVE-2015-3105_windows_py_h2"
...
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M343_test.json")
f = open(embedding_path, 'r')
...
print("end load test")
#print(end_load_test_time-start_load_test_time)
strr = np.load(base_dir / "ground_data" / (suffix + "M4h1_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
log_file = base_dir / "training_data" / f"{suffix}training_preprocessed_logs_M4-CVE_2018_8174_windows_h1"
...
start_load_test_time=time.time()
base_dir = Path(__file__).resolve().parent
embedding_path = base_dir / "embedding_data" / (suffix + f"M344_test.json")
f = open(embedding_path, 'r')
strr=f.read().split("\n")
f.close()
for i in range(len(strr)-1):
...
#print(end_load_test_time-start_load_test_time)
value2=np.array(strr[:-1])
strr = np.load(base_dir / "ground_data" / (suffix + "M4h2_number.npy"))
strr=list(strr)
labels=np.ones(len(value2))
for i in range(len(strr)):
  if int(strr[i])<=len(value2):
...
log_file = base_dir / "training_data" / f"{suffix}training_preprocessed_logs_M4-CVE_2018_8174_windows_h2"
